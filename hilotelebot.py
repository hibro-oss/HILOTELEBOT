...
RALPH_CHANNEL_ID = int(os.getenv("RALPH_CHANNEL_ID", "0"))
JOTT_CHANNEL_ID = int(os.getenv("JOTT_CHANNEL_ID", "0"))
NORTH_CHANNEL_ID = int(os.getenv("NORTH_CHANNEL_ID", "0"))
CARHARTT_CHANNEL_ID = int(os.getenv("CARHARTT_CHANNEL_ID", "0"))
LACOSTE_CHANNEL_ID = int(os.getenv("LACOSTE_CHANNEL_ID", "0"))
SNEAKERS_CHANNEL_ID = int(os.getenv("SNEAKERS_CHANNEL_ID", "0"))
TOMMY_CHANNEL_ID = int(os.getenv("TOMMY_CHANNEL_ID", "0"))
STONE_CHANNEL_ID = int(os.getenv("STONE_CHANNEL_ID", "0"))
CORTEIZ_CHANNEL_ID = int(os.getenv("CORTEIZ_CHANNEL_ID", "0"))
ADIDAS_CHANNEL_ID = int(os.getenv("ADIDAS_CHANNEL_ID", "0"))
LEVIS_CHANNEL_ID = int(os.getenv("LEVIS_CHANNEL_ID", "0"))
ACCESSOIRES_CHANNEL_ID = int(os.getenv("ACCESSOIRES_CHANNEL_ID", "0"))
...
async def accessoires(interaction: discord.Interaction):
    ...
    embed1 = discord.Embed(
            title="👜 Accessoires — Top catégories Achat/Revente",
            description="Voici les meilleures catégories d'accessoires à acheter et revendre sur Vinted et ailleurs.",
            color=0xFFD700,
        )
